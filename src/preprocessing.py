import pandas as pd
import numpy as np
from src.utils import calculate_haversine

def clean_taxi_data(df_raw, target_year=None, target_month=None):
    """
    ...
    # Auto-calculate the start and end of target month if specified
